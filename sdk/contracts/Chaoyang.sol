...
contract OpenComplainNetwork {
    ...
    function registerComplain(string data, uint cat, string loc, string phone, string img, uint x, uint y) public payable returns(uint) {
        complainMap[complainCounter]._location = loc;
        complainMap[complainCounter]._phone_number = phone;
        complainMap[complainCounter]._image_hash = img;
        complainMap[complainCounter]._gps._x = x;
        complainMap[complainCounter]._gps._y = y;
    ...
    function viewComplain(uint cid) public constant returns (uint, uint, Status, string, string, string, string) {
        return (complainMap[cid]._gps._x, complainMap[cid]._gps._y, complainMap[cid]._status, complainMap[cid]._data, complainMap[cid]._location, complainMap[cid]._phone_number, complainMap[cid]._image_hash);
    }
